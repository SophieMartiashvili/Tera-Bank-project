...
class MyMain
{
    static void Main(string[] args) // ყველა პროგრამის დასაწყებად საჭიროა, entry point
    {
        //გამომყავს კონსოლში შეტყობინება single line comment
       Console.WriteLine("Hello Sophie"); // writeline-ს გამოყავს ტექსტი + გადადის ახალ სტრიქონზე
